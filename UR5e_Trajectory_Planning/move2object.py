...
PATH_IMAGE_LOGS =  pathlib.Path(__file__).resolve().parent.parent / "images/trajectory_planning/logs"
...
class Move2Object():
    ...
    def move_muti_to_object(self):
        ...
        for marker in sorted_markers:
            ...
            target_pose_up = [point.x, point.y-0.20, point.z] + RPY
            target_pose_down = [point.x, point.y, point.z] + GRAP_RPY
